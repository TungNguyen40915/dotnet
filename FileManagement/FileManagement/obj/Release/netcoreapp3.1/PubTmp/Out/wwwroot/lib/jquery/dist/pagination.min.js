...
return[d,a]},u=function(d,a,e){b(e).html("");let f=[];var c;if(6>=a)for(c=1;c<=a;c++)f.push(c);else f=3>Math.abs(d-1)?[1,2,3,4,"...",a]:3>Math.abs(d-a)?[1,"...",a-3,a-2,a-1,a]:[1,"...",d-1,d,d+1,"...",a];c='<li class="'+h+" prev "+(1===d?"disabled":"")+'"><a class="'+p+'" href="#">dsadss</a></li>';for(let b=0;b<f.length&&!(a<=b);b++)c="..."===f[b]?c+('<li class="'+h+' page-inf disabled"><a class="'+p+'" data-page_no="..." href="#">...</a></li>'):c+('<li class="'+h+" page-"+f[b]+" "+(f[b]===d?"disabled":
"")+'"><a class="'+p+'" data-page_no="'+f[b]+'" href="#">'+f[b]+"</a></li>");c+='<li class="'+h+" next "+(d===a?"disabled":"")+'"><a class="'+p+'" href="#">dsadas</a></li>';b(e).append(c);return!0}})(jQuery);